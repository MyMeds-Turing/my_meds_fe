...
import { AllUsersObj, User } from '../../interfaces'
...
const App = () => {
  ...
  return (
    <main className="App">
      {!isLoggedIn ? <Login setUser={setUser} setMeds={setMeds} setIsLoggedIn={setIsLoggedIn} allUsers={allUsers} /> :
        <div>
